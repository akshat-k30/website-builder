...
export default function GenerateContentPage() {
  ...
  const fetchContent = async () => {
    try {
      ...
      if (res.status === 404) {
        // In Next.js client navigation, window.location might not be immediately reliable,
        // but since we are in useEffect it usually is. 
        // We use a ref to prevent React Strict Mode from double-firing and overwriting status to "empty".
